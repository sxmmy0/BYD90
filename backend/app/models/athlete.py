...
class Athlete(Base):
    ...
    secondary_positions = Column(
        JSON, nullable=True
    )  # List of additional positions
    ...
    preferred_training_time = Column(
        String(20), nullable=True
    ...
    coach_connections = relationship(
        "CoachAthleteConnection", back_populates="athlete"
    )
